...
import { Button, cn, SimpleTooltip } from "@vscrape/ui";
import { PenLineIcon, Trash2 } from "lucide-react";
import { cloneDeep } from "lodash";
import { insertOrRemoveIdsFromCurrentEditorErrors } from "../../../lib/utils";
...
const DataPreviewList = ({
  ...
  useEffect(() => {
    if (!nodeBlock) return;
    const sub = nodeBlock.stream$().subscribe((newData: any) => {
