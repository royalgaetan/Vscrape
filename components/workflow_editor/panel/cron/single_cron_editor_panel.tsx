...
const SingleCronEditorPanel = ({
  ...
  const currentBlock = cronBlockOrigin ?? getNewCronBlock();
  // State Values:
  ...
  useEffect(() => {
    const sub = currentBlock.stream$().subscribe((newData) => {
      console.log("ZZZZ DATA", newData);
      // setConfigMinute((newData as CronBlock).configMinute);
      // setConfigHour((newData as CronBlock).configHour);
      // setConfigDayOfMonth((newData as CronBlock).configDayOfMonth);
      // setConfigMonth((newData as CronBlock).configMonth);
      // setConfigDayOfWeek((newData as CronBlock).configDayOfWeek);
  ...
  return (
    <div className="flex flex-col w-full max-h-full relative">
      <div className="flex flex-col w-full max-h-full overflow-x-clip overflow-y-scroll scrollbar-hide">
        ...
        <div className="ml-2">
          <FieldLabel label="Select a Preset" />
        </div>
        ...
        <div className="flex flex-col justify-start items-start">
          ...
          <div className="flex flex-col gap-3 w-full px-4 pr-4">
            ...
            <div className="flex flex-col w-full">
              {/* Label */}
              <Label className="mb-2 text-xs text-neutral-500">Timezone</Label>
              <div className="!flex !flex-1 !w-full">
                <MultiSelect
                  ...
                  itemTooltipClassname="w-52"
                  data={appTimezones}
                  selectedValues={configTimezone ? [configTimezone] : undefined}
                  handleSelect={(value) => {
